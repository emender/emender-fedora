...
function TestCommandFlags.getSystemIdFromDB()
    local osName = TestCommandFlags.osName .. TestCommandFlags.osVersion
    local query = "SELECT id FROM system WHERE name='" .. osName .. "';"
...
function TestCommandFlags.fetchExistingData()
    ...
    if sysId == nil then
        local osName = TestCommandFlags.osName .. TestCommandFlags.osVersion
        fail("The '" .. osName .. "' system has not been found in the database.")
        return nil
    end
